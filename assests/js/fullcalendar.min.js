! function(t, e) {
    ...
    return function(t) {
        ...
        function r(t) {
            var e, n, i, r = t[0].offsetWidth - t[0].clientWidth,
                s = t[0].offsetHeight - t[0].clientHeight;
            return r = o(r), e = {
                left: 0,
                right: 0,
                top: 0,
        ...
        function l(t, e, n, i, r) {
            ...
            var o = t[n.field],
                s = e[n.field];
            return null == o && i && (o = i[n.field]), null == s && r && (s = r[n.field]), u(o, s) * (n.order || 1)
        }
        ...
        function d(t, n) {
            var i, r, o, s, a, l;
            for (i = 0; i < e.unitsDesc.length && (r = e.unitsDesc[i], s = r, a = t, !((o = null != (l = n) ? l.diff(a, s, !0) : v.isDuration(a) ? a.as(s) : a.end.diff(a.start, s, !0)) >= 1 && g(o))); i++);
            return r
        }
        ...
        e.compensateScroll = function(t, e) {
            ...
            var r = Math.floor(e / t.length),
                o = Math.floor(e - r * (t.length - 1)),
                s = [],
                a = [],
                l = [],
                u = 0;
            i(t), t.each(function(e, n) {
                var i = e === t.length - 1 ? o : r,
                    d = y(n).outerHeight(!0);
                d < i ? (s.push(n), a.push(d), l.push(y(n).height())) : u += d
            }), n && (e -= u, r = Math.floor(e / s.length), o = Math.floor(e - r * (s.length - 1))), y(s).each(function(t, e) {
                var n = t === s.length - 1 ? o : r,
                    i = a[t],
                    u = n - (i - l[t]);
                i < n && y(e).height(u)
            })
            ...
            var n = t.offset(),
                i = r(t),
                o = n.left + s(t, "border-left-width") + i.left - (e ? e.left : 0),
                a = n.top + s(t, "border-top-width") + i.top - (e ? e.top : 0);
            return {
                left: o,
                right: o + t[0].clientWidth,
                top: a,
        ...
        e.isPrimaryMouseButton = function(t) {
        ...
        }, e.preventDefault = a, e.intersectRects = function(t, e) {
            var n = {
            ...
            var e, n, i = [],
                r = [];
            for ("string" == typeof t ? r = t.split(/\s*,\s*/) : "function" == typeof t ? r = [t] : y.isArray(t) && (r = t), e = 0; e < r.length; e++) n = r[e], "string" == typeof n ? i.push("-" === n.charAt(0) ? {
                field: n.substring(1),
                order: -1
            } : {
                field: n,
            ...
            for (o = 0; o < n.length; o++)
                if (s = l(t, e, n[o], i, r)) return s;
            return 0
        }, e.compareByFieldSpec = l, e.flexibleCompare = u, e.dayIDs = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], e.unitsDesc = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"], e.diffDayTime = function(t, e) {
            return v.duration({
        ...
        }, e.computeGreatestUnit = d, e.computeDurationGreatestUnit = function(t, e) {
            var n = d(t);
            return "week" === n && "object" == typeof e && e.days && (n = "day"), n
        }, e.divideRangeByDuration = function(t, e, n) {
            var i;
            return c(n) ? (e - t) / n : (i = n.asMonths(), Math.abs(i) >= 1 && g(i) ? e.diff(t, "months", !0) / i : e.diff(t, "days", !0) / n.asDays())
        }, e.divideDurationByDuration = function(t, e) {
            var n, i;
            return c(t) || c(e) ? t / e : (n = t.asMonths(), i = e.asMonths(), Math.abs(n) >= 1 && g(n) && Math.abs(i) >= 1 && g(i) ? n / i : t.asDays() / e.asDays())
        }, e.multiplyDuration = function(t, e) {
            var n;
            return c(t) ? v.duration(t * e) : (n = t.asMonths(), Math.abs(n) >= 1 && g(n) ? v.duration({
                months: n * e
            }) : v.duration({
                days: t.asDays() * e
            }))
        }, e.durationHasTime = c, e.isNativeDate = function(t) {
            return "[object Date]" === Object.prototype.toString.call(t) || t instanceof Date
        }, e.isTimeString = function(t) {
            return "string" == typeof t && /^\d+\:\d+(?:\:\d+\.?(?:\d{3})?)?$/.test(t)
        }, e.log = p, e.warn = function() {
            for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
            var n = window.console;
        ...
        e.mergeProps = function t(e, n) {
            ...
            if (n)
                for (i = 0; i < n.length; i++) {
                    for (r = n[i], o = [], s = e.length - 1; s >= 0; s--)
        ...
        }, e.hasOwnProp = h, e.applyAll = function(t, e, n) {
        ...
        }, e.htmlEscape = f, e.stripHtmlEntities = function(t) {
            return t.replace(/&.*?;/g, "")
        }, e.cssToStr = function(t) {
            var e = [];
            return y.each(t, function(t, n) {
                null != n && e.push(t + ":" + n)
            }), e.join(";")
            ...
            return t - e
        }, e.isInt = g, e.proxy = function(t, e) {
            var n = t[e];
            return function() {
        ...
        function i(t, e, n) {
            ...
            return r.isMoment(p) || s.isNativeDate(p) || void 0 === p ? c = r.apply(null, t) : (i = !1, u = !1, h ? a.test(p) ? (t = [p += "-01"], i = !0, u = !0) : (d = l.exec(p)) && (i = !d[5], u = !0) : o.isArray(p) && (u = !0), c = e || i ? r.utc.apply(r, t) : r.apply(null, t), i ? (c._ambigTime = !0, c._ambigZone = !0) : n && (u ? c._ambigZone = !0 : h && c.utcOffset(p))), c._fullCalendar = !0, c
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        ...
        c.push("_fullCalendar"), c.push("_ambigTime"), c.push("_ambigZone"), e.oldMomentFormat = function(t, e) {
            return d.format.call(t, e)
        };
        var p = function() {
            return i(arguments)
        };
        e.default = p, p.utc = function() {
            var t = i(arguments, !0);
            return t.hasTime() && t.utc(), t
        }, p.parseZone = function() {
            return i(arguments, !0, !0)
        }, u.week = u.weeks = function(t) {
            var e = this._locale._fullCalendar_weekCalc;
            return null == t && "function" == typeof e ? e(this) : "ISO" === e ? d.isoWeek.apply(this, arguments) : d.week.apply(this, arguments)
        }, u.time = function(t) {
            ...
            return d.local.call(this, this._ambigZone || t), this._ambigTime = !1, this._ambigZone = !1, this
        }, u.utc = function(t) {
            return d.utc.call(this, t), this._ambigTime = !1, this._ambigZone = !1, this
        }, u.utcOffset = function(t) {
            return null != t && (this._ambigTime = !1, this._ambigZone = !1), d.utcOffset.apply(this, arguments)
        }
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var i = n(16);
        e.viewHash = {}, i.views = e.viewHash, e.defineView = function(t, n) {
            e.viewHash[t] = n
        ...
        var o = n(2),
            ...
            a = function(t) {
                ...
                return o.__extends(e, t), e.prototype.handleInteractionStart = function(e) {
                    ...
                    var o;
                    t.prototype.handleDrag.call(this, e, n, r), i(o = this.queryHit(s.getEvX(r), s.getEvY(r)), this.hit) || (this.hit && this.handleHitOut(), o && this.handleHitOver(o))
        ...
        function i(t, n) {
            var i, s;
            i = e.localeOptionHash[t] || (e.localeOptionHash[t] = {}), n && (i = e.localeOptionHash[t] = l.mergeOptions([i, n])), s = r(t), o.each(c, function(t, e) {
                null == i[t] && (i[t] = e(s, i))
        ...
        e.populateInstanceComputableOptions = function(t) {
            ...
            r.isRTL = i.isRTL, r.weekNumberTitle = i.weekHeader, o.each(d, function(t, e) {
                r[t] = e(i)
            });
            var s = o.datepicker;
            s && (s.regional[n] = s.regional[t] = i, s.regional.en = s.regional[""], s.setDefaults(i))
        }, e.locale = i, e.getMomentLocaleData = r, i("en", l.englishDefaults)
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        ...
        var i = n(4),
            ...
            l = function() {
                ...
                return t.createFromRawProps = function(e, n, a) {
                    ...
                    return (u = r.default.parse(h, p.source)) && (d = s.default.createFromDiff(e.dateProfile, u, a)), f.id !== p.id && (y = f.id), i.isArraysEqual(f.className, p.className) || (m = f.className), o.default.copyVerbatimStandardProps(f, v), (c = new t).eventDefId = y, c.className = m, c.verbatimStandardProps = v, c.miscProps = g, d && (c.dateMutation = d), c
            ...
            p = function(t) {
                ...
                return i.__extends(e, t), e.prototype._getView = function() {
                    ...
                    var r = this.calendar.eventManager.mutateEventsWithId(t.def.id, e),
                        s = e.dateMutation;
                    s && (t.dateProfile = s.buildNewDateProfile(t.dateProfile, this.calendar)), this.triggerEventDrop(t, s && s.dateDelta || o.duration(), r, n, i)
        ...
        function r(t, e) {
            return u(l(o(e).fakeFormatString, t).join(""))
        }
        ...
        function o(t) {
            return y[t] || (y[t] = {
                fakeFormatString: function t(e) {
                    var n, i, r = [];
                    for (n = 0; n < e.length; n++) i = e[n], "string" == typeof i ? r.push("[" + i + "]") : i.token ? i.token in g ? r.push(p + "[" + i.token + "]") : r.push(i.token) : i.maybe && r.push(h + t(i.maybe) + h);
                    return r.join(c)
                }(e = s(t)),
                sameUnits: function t(e) {
                    var n, i, r, o = [];
                    for (n = 0; n < e.length; n++) i = e[n], i.token ? (r = v[i.token.charAt(0)], o.push(r ? r.unit : "second")) : i.maybe ? o.push.apply(o, t(i.maybe)) : o.push(null);
                    return o
                }(e)
            });
            var e
        ...
        function l(t, e) {
            var n, i, r = [],
                o = d.oldMomentFormat(e, t).split(c);
            for (n = 0; n < o.length; n++) i = o[n], i.charAt(0) === p ? r.push(g[i.substring(1)](e)) : r.push(i);
            return r
        }
        ...
        d.newMomentProto.format = function() {
            return this._fullCalendar && arguments[0] ? r(this, arguments[0]) : this._ambigTime ? d.oldMomentFormat(i(this), "YYYY-MM-DD") : this._ambigZone ? d.oldMomentFormat(i(this), "YYYY-MM-DD[T]HH:mm:ss") : this._fullCalendar ? d.oldMomentFormat(i(this)) : d.oldMomentProto.format.apply(this, arguments)
        }, d.newMomentProto.toISOString = function() {
            return this._ambigTime ? d.oldMomentFormat(i(this), "YYYY-MM-DD") : this._ambigZone ? d.oldMomentFormat(i(this), "YYYY-MM-DD[T]HH:mm:ss") : this._fullCalendar ? d.oldMomentProto.toISOString.apply(i(this), arguments) : d.oldMomentProto.toISOString.apply(this, arguments)
        };
        var c = "\v",
            p = "",
            h = "",
            f = new RegExp(h + "([^" + h + "]*)" + h, "g"),
            g = {
                t: function(t) {
        ...
        e.formatDate = r, e.formatRange = function(t, e, n, i, r) {
            return t = d.default.parseZone(t), e = d.default.parseZone(e),
                function(t, e, n, i, r) {
                    var o, s, a, d = t.sameUnits,
                        c = e.clone().stripZone(),
                        p = n.clone().stripZone(),
                        h = l(t.fakeFormatString, e),
                        f = l(t.fakeFormatString, n),
                        g = "",
                        v = "",
                        y = "",
                        m = "",
                        b = "";
                    for (o = 0; o < d.length && (!d[o] || c.isSame(p, d[o])); o++) g += h[o];
                    for (s = d.length - 1; s > o && (!d[s] || c.isSame(p, d[s])) && (s - 1 !== o || "." !== h[s]); s--) v = h[s] + v;
                    for (a = o; a <= s; a++) y += h[a], m += f[a];
                    return (y || m) && (b = r ? m + i + y : y + i + m), u(g + b + v)
                }(o(n = t.localeData().longDateFormat(n) || n), t, e, i || " - ", r)
        };
        var y = {};
        e.queryMostGranularFormatUnit = function(t) {
            var e, n, i, r, o = s(t);
            for (e = 0; e < o.length; e++) n = o[e], n.token && (i = v[n.token.charAt(0)]) && (!r || i.value > r.value) && (r = i);
            ...
            a = function(t) {
                ...
                return i.__extends(e, t), e.watch = function(t) {
                    ...
                    return t.forEach(function(t) {
                        var i = !1;
                        "?" === t.charAt(0) && (t = t.substring(1), i = !0), d("before:change:" + t, function(t) {
                            1 == ++r && s === o && (u = !0, n(a), u = !1)
                        }), d("change:" + t, function(n) {
                            var l, d, c;
                            l = t, c = i, void 0 === (d = n) ? (c || void 0 === a[l] || s--, delete a[l]) : (c || void 0 !== a[l] || s++, a[l] = d), --r || s === o && (u || e(a))
                        })
        ...
        var i = n(4),
            ...
            o = function() {
                ...
                return t.createFromDiff = function(e, n, r) {
                    ...
                    var s, a, l, u = e.end && !n.end,
                        d = e.isAllDay() && !n.isAllDay(),
                        c = !e.isAllDay() && n.isAllDay();
                    return s = o(n.start, e.start), n.end && (a = o(n.unzonedRange.getEnd(), e.unzonedRange.getEnd()).subtract(s)), (l = new t).clearEnd = u, l.forceTimed = d, l.forceAllDay = c, l.setDateDelta(s), l.setEndDelta(a), l
        ...
        var i = n(3),
            ...
            o = function() {
                ...
                return t.prototype.build = function() {
                    ...
                    var t;
                    return this.els.length > 0 && !(t = r.getScrollParent(this.els.eq(0))).is(document) ? r.getClientRect(t) : null
                ...
                return t.prototype.renderFootprint = function(t, e, n) {
                    ...
                    if (e.length) {
                        ...
                        i(s).each(function(t, r) {
                            var s = e[t],
                                l = i(r);
                            n.filterEl && (l = n.filterEl(s, l)), l && ((l = i(l)).is(o.fillSegTag) && (s.el = l, a.push(s)))
                        })
                    }
                    return a
        ...
        var i = n(2),
            ...
            m = function(t) {
                ...
                return i.__extends(e, t), e.prototype.componentFootprintToSegs = function(t) {
                    ...
                    var n, i, o, s = this.rowEls.eq(t).height(),
                        a = this.eventRenderer.rowStructs[t].tbodyEl.children();
                    for (n = 0; n < a.length; n++)
                        if (i = a.eq(n).removeClass("fc-limited"), o = 0, i.find("> td > :first-child").each(e), i.position().top + o > s) return n;
                    return !1
                    ...
                    if (e && e < b.segLevels.length) {
                        for (n = b.segLevels[e - 1], i = b.cellMatrix, o = b.tbodyEl.children().slice(e).addClass("fc-limited").get(), s = 0; s < n.length; s++) {
                            ...
                            if (u) {
                                for (p = (c = i[e - 1][a.leftCol]).attr("rowspan") || 1, h = [], f = 0; f < d.length; f++) g = r('<td class="fc-more-cell"/>').attr("rowspan", p), l = d[f], y = this.renderMoreLink(t, a.leftCol + f, [a].concat(l)), v = r("<div/>").append(y), g.append(v), h.push(g[0]), w.push(g[0]);
                    ...
                    var i, s = this.view.calendar.theme,
                        ...
                        l = r('<div class="fc-header ' + s.getClass("popoverHeader") + '"><span class="fc-close ' + s.getIconClass("close") + '"></span><span class="fc-title">' + o.htmlEscape(a) + '</span><div class="fc-clear"/></div><div class="fc-body ' + s.getClass("popoverContent") + '"><div class="fc-event-container"></div></div>'),
                        u = l.find(".fc-event-container");
                    for (n = this.eventRenderer.renderFgSegEls(n, !0), this.popoverSegs = n, i = 0; i < n.length; i++) this.hitsNeeded(), n[i].hit = this.getCellHit(t, e), this.hitsNotNeeded(), u.append(n[i].el);
                    return l
        ...
        var i = n(2),
            ...
            d = function(t) {
                function e(e, n) {
                    var i = t.call(this, e, n) || this;
                    return i.dayGrid = i.instantiateDayGrid(), i.dayGrid.isRigid = i.hasRigidRows(), i.opt("weekNumbers") && (i.opt("weekNumbersWithinDays") ? (i.dayGrid.cellWeekNumbersVisible = !0, i.dayGrid.colWeekNumbersVisible = !1) : (i.dayGrid.cellWeekNumbersVisible = !1, i.dayGrid.colWeekNumbersVisible = !0)), i.addChild(i.dayGrid), i.scroller = new s.default({
                        overflowX: "hidden",
                        overflowY: "auto"
                    }), i
                }
            ...
            l = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    var e, n = t.getEventDef(),
                        ...
                        r = this.getPeerEventInstances(n).map(a.eventInstanceToEventRange),
                        o = this.eventRangesToEventFootprints(r),
                        s = n.getConstraint(),
                        l = n.getOverlap(),
                        u = this.opt("eventAllow");
                    for (e = 0; e < i.length; e++)
                        if (!this.isFootprintAllowed(i[e].componentFootprint, o, s, l, i[e].eventInstance)) return !1;
                    if (u)
                        for (e = 0; e < i.length; e++)
                            if (!1 === u(i[e].componentFootprint.toLegacy(this._calendar), i[e].getEventLegacy())) return !1;
                    return !0
        ...
        e.default = r, r.prototype.classes = {
            widget: "fc-unthemed",
            ...
            l = function(t) {
                ...
                return i.__extends(e, t), e.parse = function(t, e) {
                    ...
                    var i, o, s, a, l = this.calendar,
                        u = this.ajaxSettings,
                        d = {};
                    return null == (i = this.startParam) && (i = l.opt("startParam")), null == (o = this.endParam) && (o = l.opt("endParam")), null == (s = this.timezoneParam) && (s = l.opt("timezoneParam")), a = r.isFunction(u.data) ? u.data() : u.data || {}, r.extend(d, a), d[i] = t.format(), d[o] = e.format(), n && "local" !== n && (d[s] = n), d
                }, e.prototype.getPrimitive = function() {
                    return this.url
        ...
        var i = n(2),
            ...
            c = function(t) {
                ...
                return i.__extends(e, t), e.prototype.addChild = function(t) {
                    ...
                    var i, o, l, u;
                    return r.isPlainObject(t) ? (i = t.date, o = t.type, l = t.forceOff) : i = t, u = {
                    ...
                    var n, i = this._getView(),
                        r = [];
                    return this.dateProfile.activeUnzonedRange.containsDate(t) ? (r.push("fc-" + s.dayIDs[t.day()]), i.isDateInOtherMonth(t, this.dateProfile) && r.push("fc-other-month"), n = i.calendar.getNow(), t.isSame(n, "day") ? (r.push("fc-today"), !0 !== e && r.push(i.calendar.theme.getClass("today"))) : t < n ? r.push("fc-past") : r.push("fc-future")) : r.push("fc-disabled-day"), r
                }, e.prototype.formatRange = function(t, e, n, i) {
                    var r = t.end;
                    return e && (r = r.clone().subtract(1)), l.formatRange(t.start, r, n, i, this.isRTL)
                ...
                return t.prototype.constructed = function() {}, t.prototype.getView = function() {
                    ...
                    e.addClass("fc"), e.on("click.fc", "a[data-goto]", function(e) {
                        var n = r(e.currentTarget).data("goto"),
                            i = t.moment(n.date),
                            o = n.type,
                            a = t.view.opt("navLink" + s.capitaliseFirstLetter(o) + "Click");
                        "function" == typeof a ? a(i, e) : ("string" == typeof a && (o = a), t.zoomTo(i, o))
                    }), this.optionsManager.watch("settingTheme", ["?theme", "?themeSystem"], function(n) {
                        var i = new(I.getThemeSystemClass(n.themeSystem || n.theme))(t.optionsManager),
                            r = i.getClass("widget");
                        t.theme = i, r && e.addClass(r)
                    }, function() {
                    ...
                    this.defaultAllDayEventDuration = o.duration(this.opt("defaultAllDayEventDuration")), this.defaultTimedEventDuration = o.duration(this.opt("defaultTimedEventDuration")), this.optionsManager.watch("buildingMomentLocale", ["?locale", "?monthNames", "?monthNamesShort", "?dayNames", "?dayNamesShort", "?firstDay", "?weekNumberCalculation"], function(e) {
                        ...
                        e.monthNames && (o._months = e.monthNames), e.monthNamesShort && (o._monthsShort = e.monthNamesShort), e.dayNames && (o._weekdays = e.dayNames), e.dayNamesShort && (o._weekdaysShort = e.dayNamesShort), null == r && "ISO" === i && (r = 1), null != r && ((n = Object.create(o._week)).dow = r, o._week = n), "ISO" !== i && "local" !== i && "function" != typeof i || (o._fullCalendar_weekCalc = i), t.localeData = o, t.currentDate && t.localizeMoment(t.currentDate)
                    })
        ...
        var i = n(0),
            ...
            s = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    void 0 === n && (n = !1);
                    var r, o, s, a, l, u, d, c, p = !t.hasTime();
                    return r = this.buildValidRange(), r = this.trimHiddenDays(r), n && (t = this.msToUtcMoment(r.constrainDate(t), p)), o = this.buildCurrentRangeInfo(t, e), s = /^(year|month|week|day)$/.test(o.unit), a = this.buildRenderRange(this.trimHiddenDays(o.unzonedRange), o.unit, s), l = (a = this.trimHiddenDays(a)).clone(), this.opt("showNonCurrentDates") || (l = l.intersect(o.unzonedRange)), d = i.duration(this.opt("minTime")), c = i.duration(this.opt("maxTime")), (l = (l = this.adjustActiveRange(l, d, c)).intersect(r)) && (t = this.msToUtcMoment(l.constrainDate(t), p)), u = o.unzonedRange.intersectsWith(r), {
                        validUnzonedRange: r,
                    ...
                    return h || ((l = this.opt("dateIncrement")) ? (u = i.duration(l), h = u < n ? r.computeDurationGreatestUnit(u, l) : s) : h = s), n.as("days") <= 1 && this._view.isHiddenDay(d) && (d = this._view.skipHiddenDays(d, e)).startOf("day"), a(), this.trimHiddenDays(p) || (t = this._view.skipHiddenDays(t, e), a()), p
                }, t.prototype.buildRangeFromDayCount = function(t, e, n) {
                    var i, r = this.opt("dateAlignment"),
                        s = 0,
                        a = t.clone();
                    r && a.startOf(r), a.startOf("day"), i = (a = this._view.skipHiddenDays(a, e)).clone();
                    do {
        ...
        var i = n(2),
            ...
            f = function(t) {
                ...
                return i.__extends(e, t), e.prototype.end = function() {
                    ...
                    var i, l, u, c, h, f, g, v = this,
                        y = this.component,
                        m = this.view,
                        b = (l = t, (g = s.dataAttrPrefix) && (g += "-"), (u = l.data(g + "event") || null) && (null == (c = (u = "object" == typeof u ? r.extend({}, u) : {}).start) && (c = u.time), h = u.duration, f = u.stick, delete u.start, delete u.time, delete u.duration, delete u.stick), null == c && (c = l.data(g + "start")), null == c && (c = l.data(g + "time")), null == h && (h = l.data(g + "duration")), null == f && (f = l.data(g + "stick")), {
                            eventProps: u,
                            startTime: c = null != c ? o.duration(c) : null,
                            duration: h = null != h ? o.duration(h) : null,
                            stick: f = Boolean(f)
                        });
                    (this.dragListener = new d.default(y, {
                        ...
                        hitOver: function(t) {
                            ...
                            r ? (i = v.computeExternalDrop(r, b)) ? (e = new p.default(i.buildInstances()), n = b.eventProps ? y.isEventInstanceGroupAllowed(e) : y.isExternalInstanceGroupAllowed(e)) : n = !1 : n = !1, n || (i = null, a.disableCursor()), i && y.renderDrag(y.eventRangesToEventFootprints(e.sliceRenderRanges(y.dateProfile.renderUnzonedRange, m.calendar)))
                        },
                        hitOut: function() {
                            i = null
                        },
                        hitDone: function() {
                            a.enableCursor(), y.unrenderDrag()
                        },
                        interactionEnd: function(e) {
                            i && m.reportExternalDrop(i, Boolean(b.eventProps), Boolean(b.stick), t, e, n), v.isDragging = !1, v.dragListener = null
                        }
                    })).startDrag(e)
                }, e.prototype.computeExternalDrop = function(t, e) {
                    var n, i = this.view.calendar,
                        o = l.default.utc(t.unzonedRange.startMs).stripZone();
                    return t.isAllDay && (e.startTime ? o.time(e.startTime) : o.stripTime()), e.duration && (n = o.clone().add(e.duration)), o = i.applyTimezone(o), n && (n = i.applyTimezone(n)), c.default.parse(r.extend({}, e.eventProps, {
                        start: o,
                        end: n
                    }), new h.default(i))
                }, e
                ...
                return i.__extends(e, t), e.prototype.end = function() {
                    ...
                    return this.dragListener = new l.default(s, {
                        ...
                        hitOver: function(n, l, c) {
                            ...
                            g && v ? (i = e ? r.computeEventStartResizeMutation(g, v, t.footprint) : r.computeEventEndResizeMutation(g, v, t.footprint)) ? (h = d.buildMutatedEventInstanceGroup(p.id, i), f = s.isEventInstanceGroupAllowed(h)) : f = !1 : f = !1, f ? i.isEmpty() && (i = null) : (i = null, o.disableCursor()), i && (a.hideEventsWithId(t.footprint.eventDef.id), a.renderEventResize(s.eventRangesToEventFootprints(h.sliceRenderRanges(s.dateProfile.renderUnzonedRange, u)), t))
                        },
                        hitOut: function() {
                            i = null
                        },
                    ...
                    return o.getStart().add(l) < o.getEnd() && ((i = new a.default).setStartDelta(l), (r = new s.default).setDateMutation(i), r)
                    ...
                    return o.getEnd().add(l) > o.getStart() && ((i = new a.default).setEndDelta(l), (r = new s.default).setDateMutation(i), r)
                }, e
            }(n(15).default);
        e.default = u
    }, function(t, e, n) {
            ...
            d = function(t) {
                ...
                return i.__extends(e, t), e.prototype.end = function() {
                    ...
                    var n, i, r = t.unzonedRange.getStart(),
                        ...
                        l = !1,
                        u = !1;
                    return t.isAllDay !== e.isAllDay && (a = !0, e.isAllDay ? (u = !0, r.stripTime()) : l = !0), n = this.component.diffDates(o, r), (i = new s.default).clearEnd = a, i.forceTimed = l, i.forceAllDay = u, i.setDateDelta(n), i
                }, e
            }(n(15).default);
        e.default = d
    }, function(t, e, n) {
                ...
                return i.__extends(e, t), e.prototype.end = function() {
                    ...
                    return new o.default(n, {
                        ...
                        hitOver: function(i, o, s) {
                            var a, l;
                            s && (a = n.getSafeHitFootprint(s), l = n.getSafeHitFootprint(i), (t = a && l ? e.computeSelection(a, l) : null) ? n.renderSelectionFootprint(t) : !1 === t && r.disableCursor())
                        },
                        hitOut: function() {
        ...
        var i = n(3),
            ...
            h = function() {
                ...
                return t.prototype.requestEvents = function(t, e, n, i) {
                    ...
                    var e, n, r = this.otherSources;
                    for (e = 0; e < r.length; e++)
                        if ((n = r[e]) === t) return [n];
                    return (n = this.getSourceById(a.default.normalizeId(t))) ? [n] : (t = l.default.parse(t, this.calendar)) ? i.grep(r, function(e) {
        ...
        function i(t) {
            ...
            if (void 0 === t.forwardPressure) {
                for (e = 0; e < r.length; e++) n = r[e], i(n), o = Math.max(o, 1 + n.forwardPressure);
                t.forwardPressure = o
            }
        }
        ...
        var o = n(2),
            ...
            a = function(t) {
                ...
                return o.__extends(e, t), e.prototype.renderFgSegs = function(t) {
                    ...
                    var n, i, r, o = this.view,
                        ...
                        g = s.cssToStr(this.getSkinCss(d));
                    if (f.unshift("fc-time-grid-event", "fc-v-event"), o.isMultiDayRange(l.unzonedRange)) {
                        if (t.isStart || t.isEnd) {
                            var v = a.msToMoment(t.startMs),
                                y = a.msToMoment(t.endMs);
                            n = this._getTimeText(v, y, u), i = this._getTimeText(v, y, u, "LT"), r = this._getTimeText(v, y, u, null, !1)
                        }
                    } else n = this.getTimeText(t.footprint), i = this.getTimeText(t.footprint, "LT"), r = this.getTimeText(t.footprint, null, !1);
                    return '<a class="' + f.join(" ") + '"' + (d.url ? ' href="' + s.htmlEscape(d.url) + '"' : "") + (g ? ' style="' + g + '"' : "") + '><div class="fc-content dragscroll">' + (n ? '<div class="fc-time" data-start="' + s.htmlEscape(r) + '" data-full="' + s.htmlEscape(i) + '"><span>' + s.htmlEscape(n) + "</span></div>" : "") + (d.title ? '<div class="fc-title">' + s.htmlEscape(d.title) + "</div>" : "") + '</div><div class="fc-bg"/>' + (h ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
                    ...
                    if (this.sortEventSegs(t), function(t) {
                            ...
                            for (e = 0; e < t.length; e++)
                                for (n = t[e], i = 0; i < n.length; i++)
                                    for (o = n[i], o.forwardSegs = [], s = e + 1; s < t.length; s++) r(o, t[s], o.forwardSegs)
                        }(e = function(t) {
                            var e, n, i, o = [];
                            for (e = 0; e < t.length; e++) {
                                for (n = t[e], i = 0; i < o.length && r(n, o[i]).length; i++);
                                n.level = i, (o[i] || (o[i] = [])).push(n)
                            }
                            return o
                        }(t)), n = e[0]) {
                        for (o = 0; o < n.length; o++) i(n[o]);
                        for (o = 0; o < n.length; o++) this.computeFgSegForwardBack(n[o], 0, 0)
                    }
                    ...
                    t.sort(s.proxy(this, "compareForwardSegs"))
            ...
            o = function(t) {
                ...
                return i.__extends(e, t), e.prototype.renderSegs = function(t, e) {
                    ...
                    return n = this.eventRenderer.renderSegRows(t), this.component.rowEls.each(function(t, o) {
                        ...
                        e && e.row === t ? a = e.el.position().top : ((s = l.find(".fc-content-skeleton tbody")).length || (s = l.find(".fc-content-skeleton table")), a = s.position().top), u.css("top", a).find("table").append(n[t].tbodyEl), l.append(u), i.push(u[0])
                    }), r(i)
                }, e
            }(n(58).default);
        e.default = o
            ...
            o = function(t) {
                ...
                return i.__extends(e, t), e.prototype.attachSegEls = function(t, e) {
                    ...
                    var n, i, o, s = this.component.colCnt,
                        a = e.leftCol,
                        l = e.rightCol + 1;
                    return n = "businessHours" === t ? "bgevent" : t.toLowerCase(), o = (i = r('<div class="fc-' + n + '-skeleton"><table><tr/></table></div>')).find("tr"), a > 0 && o.append('<td colspan="' + a + '"/>'), o.append(e.el.attr("colspan", l - a)), l < s && o.append('<td colspan="' + (s - l) + '"/>'), this.component.bookendCells(o), i
                }, e
            }(n(57).default);
        e.default = o
    }, function(t, e, n) {
